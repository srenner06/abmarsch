...
const translations: Translations = {
  it: {
    ...
    'home.precise-progress.title': 'Così tanto ti manca',
    'home.precise-progress.hours': 'Ore',
    'home.precise-progress.minutes': 'Minuti',
    'home.precise-progress.seconds': 'Secondi',
    'ranks.ended.nef': 'NEF!',
    'ranks.ended.ef': 'EF!',
    'ranks.ended.text': 'Hai avuto {{count}} su {{total}} al primo tentativo!',
    'ranks.ended.evaluation': 'Valutazione:',
    'ranks.ended.retries': '{{retries}} tentativi',
    'ranks.ended.first-try-right': 'Al primo tentativo giusto',
    'ranks.ended.restart': 'Ricomincia tutto da capo!',
    'ranks.title': 'Gradi',
  ...
  de: {
    ...
    'home.precise-progress.title': 'So vill muesch no',
    'home.precise-progress.hours': 'Stundä',
    'home.precise-progress.minutes': 'Minutä',
    'home.precise-progress.seconds': 'Sekundä',
    'ranks.ended.nef': 'NEF!',
    'ranks.ended.ef': 'EF!',
    'ranks.ended.text': 'Du hesch {{count}} vo {{total}} ufä erscht Versuech richtig gha!',
    'ranks.ended.evaluation': 'Uswärtig:',
    'ranks.ended.retries': '{{retries}} Versüech',
    'ranks.ended.first-try-right': 'Ufä erscht Versuech richtig',
    'ranks.ended.restart': 'Das ganze noch ein mal!',
    'ranks.title': 'Grade',
  ...
  fr: {
    ...
    'home.precise-progress.title': 'Il te reste encore',
    'home.precise-progress.hours': 'Heures',
    'home.precise-progress.minutes': 'Minutes',
    'home.precise-progress.seconds': 'Secondes',
    'ranks.ended.nef': 'NEF!',
    'ranks.ended.ef': 'EF!',
    'ranks.ended.text': 'Tu as eu {{count}} sur {{total}} du premier coup!',
    'ranks.ended.evaluation': 'Évaluation:',
    'ranks.ended.retries': '{{retries}} essais',
    'ranks.ended.first-try-right': 'Au premier essai juste',
    'ranks.ended.restart': 'Tout recommencer!',
    'ranks.title': 'Rangs',
